...
| Hosted retrieval and target fit | Existing pure retrieval keeps its deterministic channel, lane, hard-filter, provenance, performance, and determinism coverage; R3 adds fresh PostgreSQL bootstrap, coherent read-only serving reconstruction, least-privilege denial, corruption closure, and committed-versus-loaded equivalence; a future hosted application adds request-boundary, bounded model-output, deterministic validation, and later critical user-journey coverage                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
