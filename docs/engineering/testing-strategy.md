...
| Phase 8 retrieval foundation | Exact taxonomy/alias validation; deterministic normalization and clarification gold; generated candidate-constraint eligibility; independent retrieval relevance judgments; deterministic metrics, offline baselines, and drift-checked content-free reports                                                                                                                                                                                                                                                                                                                                                           |
