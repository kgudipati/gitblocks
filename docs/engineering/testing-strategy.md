...
Phase 10 candidate-authority readiness-correction tests remain pre-live and
effect-denied. They validate the successor policy, field plan, source budget,
and closed partial-evidence authority without candidate provider values or an
all-candidate corpus. Synthetic unit fixtures prove that meaningful positive
partial extractors qualify while always-unknown, human-reviewed, and
model-derived generation does not; incomplete sources and missing structured
values never become negative claims; exact package/dependency/Compose facts
remain partial; and field-bound evidence survives pure `CandidateDossierV1`
projection with the unresolved remainder intact. Extraction-path counts,
full-closure counts, breadth, and per-cell origins remain separate. The
correction CLI reads only committed governance JSON and reports zero network,
candidate-provider, credential, database, Docker, model, write,
source-generation, all-candidate projection, and coverage effects.
...
| Phase 10 ranking authority                | `pnpm eval:ranking:validate` proves the accepted composite ranking-v1 30-case/6-family manifest, exact reviewed-file hashes, independent-review/gate bindings, physical authority separation, request-independent candidate facts, criterion reachability, decision-minimal evidence, rationale closure, controlled-pair maximal sets, positive-pair closure, and Phase 9 evidence-needed derivation; `pnpm eval:ranking:fixtures` proves 21 scorer fixtures; `pnpm eval:ranking:baselines` reproduces five complete blind prediction sets and reports; `pnpm eval:ranking:verify` adds permutation and maximum-results closure, composition, the 20-candidate/2,000-evidence/60-criterion reference, contract conformance, product blindness, effect denial, and no-write checks. Historical authored/proposed gold is accepted through the separate review record; production ranking remains prohibited and M3 is authorized but not begun.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Phase 10 M3A pre-live candidate authority | `pnpm candidate-authority:validate` validates the frozen 18-field plan, unchanged 13/18 plus breadth gate, NO-GO, bounded provider policy, request ceilings, failures, and digests. `pnpm candidate-authority:fixtures` covers positive, zero, complete absence, partial/temporary unknown, malformed/mismatch/unsupported inputs, negative closure, mutable freshness, repo-only N/A, source conflict, evidence/dossier projection, and input permutation replay. `pnpm candidate-authority:preflight` proves zero network, credential, database, Docker, model, write, collection, source-authority, all-candidate projection, and coverage effects. No fixture estimates all-150 coverage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Phase 10 M3A readiness/source correction  | `pnpm candidate-authority:correction:validate` binds accepted policy v3, the successor 18-field plan, separate 13 planned-capability/realized-unmeasured/6 planned-full-closure measures, planned and realized breadth rules, closed partial semantic registry v2/evidence v3, and source policy v5 with ADR 0006-bounded head resolution plus exact provider-returned license-path provenance. `pnpm candidate-authority:correction:fixtures` proves zero-output and N/A-only realized exclusion, human/model exclusion, wrong field/rule/provenance/value and negative-fact rejection, exact package-entry-point, primary-language, peer-relation, datastore non-requirement, candidate-linked Compose, exact-root Dockerfile tree/blob/hash/UTF-8/size and conservative-parser boundaries, Git ref/commit-object identity, safe license-path retention/encoding, traversal/absolute/control/query/fragment rejection, cross-candidate provenance rejection, coexisting partial evidence/dossier retention, unknown preservation, and permutation stability. `pnpm candidate-authority:correction:preflight` proves zero network, candidate-provider, credential, database, Docker, model, write, collection, source-authority, all-candidate projection, and coverage effects.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
schemas. The additive accepted review binds the exact authored gold and all 30
cases with zero disputes. The accepted gate authority freezes exact
conformance, 13/18 readiness with four-group breadth qualification, pure-engine
resource budgets, and deterministic mechanical proof. Milestone 2 is accepted;
M3 is authorized only for the candidate-authority successor and has not begun.
