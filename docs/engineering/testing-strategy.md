...
| Phase 8 retrieval foundation | `pnpm taxonomy:validate` source/schema/semantic/order/digest/drift closure; exact taxonomy/alias graph and abuse tests; deterministic normalization and clarification gold; generated candidate-constraint eligibility; independent retrieval relevance judgments; deterministic metrics, offline baselines, and drift-checked content-free reports                                                                                                                                                                                                                                                                    |
