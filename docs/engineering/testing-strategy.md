...
| Phase 10 M3A readiness correction         | `pnpm candidate-authority:correction:validate` binds policy v3, the successor 18-field plan, separate 13 planned-capability/realized-unmeasured/6 planned-full-closure measures, planned and realized breadth rules, the closed partial semantic registry, and the ADR 0006-bounded source policy. `pnpm candidate-authority:correction:fixtures` proves zero-output and N/A-only realized exclusion, human/model exclusion, wrong field/rule/provenance/value and negative-fact rejection, exact package-entry-point, primary-language, peer-relation, datastore non-requirement, candidate-linked Compose, Git ref/commit-object, partial-evidence/dossier retention, unknown preservation, and permutation stability. `pnpm candidate-authority:correction:preflight` proves zero network, candidate-provider, credential, database, Docker, model, write, collection, source-authority, all-candidate projection, and coverage effects.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
