...
| Phase 10 M3A readiness/source correction  | `pnpm candidate-authority:correction:validate` binds accepted policy v3, the successor 18-field plan, separate 13 planned-capability/realized-unmeasured/6 planned-full-closure measures, planned and realized breadth rules, closed partial semantic registry v2/evidence v3, and the ADR 0006-bounded source policy v4. `pnpm candidate-authority:correction:fixtures` proves zero-output and N/A-only realized exclusion, human/model exclusion, wrong field/rule/provenance/value and negative-fact rejection, exact package-entry-point, primary-language, peer-relation, datastore non-requirement, candidate-linked Compose, exact-root Dockerfile tree/blob/hash/UTF-8/size and conservative-parser boundaries, Git ref/commit-object identity, coexisting partial evidence/dossier retention, unknown preservation, and permutation stability. `pnpm candidate-authority:correction:preflight` proves zero network, candidate-provider, credential, database, Docker, model, write, collection, source-authority, all-candidate projection, and coverage effects.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
