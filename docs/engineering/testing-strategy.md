...
| Hosted retrieval and target fit | Existing pure retrieval keeps its deterministic channel, lane, hard-filter, provenance, performance, and determinism coverage; a future hosted application adds request-boundary, PostgreSQL composition, bounded model-output, deterministic validation, and critical user-journey coverage only when those paths are implemented                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
