...
| Phase 10 M3A readiness correction         | `pnpm candidate-authority:correction:validate` binds policy v2, the successor 18-field plan, separate 14 extraction-path/6 full-closure counts, all four breadth groups, and revised bounded source policy. `pnpm candidate-authority:correction:fixtures` proves positive-only partial rules, always-unknown/human/model exclusion, negative-claim completeness, exact partial-evidence/dossier retention, provenance, and permutation stability. `pnpm candidate-authority:correction:preflight` proves zero network, candidate-provider, credential, database, Docker, model, write, collection, source-authority, all-candidate projection, and coverage effects.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
