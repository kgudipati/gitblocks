...
describe('product contract conformance CLI', () => {
  it('reports conformance without scoring or accepting proposed gold', () => {
    ...
    expect(capture.logs).toEqual([
      'Product contract conformance passed (10 cases, 40 supplied candidates, proposed/not-reviewed, representability-only; ranking-v1 30 cases, 120 supplied candidates, proposed/not-reviewed, representability-and-mapping-completeness-only).',
    ]);
  });
