...
export {
  CANDIDATE_AUTHORITY_FIELD_PLAN_V3_DIGEST,
  CANDIDATE_AUTHORITY_FIELD_PLAN_V3_PATH,
  CANDIDATE_AUTHORITY_FIELD_PLAN_V3_VERSION,
  ...
  CANDIDATE_AUTHORITY_ROOT_V3_VERSION,
  CANDIDATE_AUTHORITY_SOURCE_POLICY_V3_DIGEST,
  CANDIDATE_AUTHORITY_SOURCE_POLICY_V3_PATH,
  CANDIDATE_AUTHORITY_SOURCE_POLICY_V3_VERSION,
  candidateAuthorityRootV3SemanticDigest,
  ...
  type CandidateAuthorityFieldPlanEntryV3,
  type CandidateAuthorityFieldPlanV3,
  type CandidateAuthorityFieldPostureV3,
  ...
  type CandidateAuthorityRootV3,
  type CandidateAuthoritySourcePolicyV3,
