...
export interface CandidateAuthoritySuccessorPreflightResult {
  ...
  readonly parentHead: typeof CANDIDATE_AUTHORITY_ACCEPTED_CORRECTION_PARENT;
...
export interface CandidateAuthoritySuccessorFailureDiagnostic {
  ...
  readonly operatorVersion: typeof CANDIDATE_AUTHORITY_LIVE_OPERATOR_V6_VERSION;
  readonly authorizationVersion: typeof CANDIDATE_AUTHORITY_LIVE_AUTHORIZATION_V6_VERSION;
  readonly authorizationDigest: typeof CANDIDATE_AUTHORITY_LIVE_AUTHORIZATION_V6_DIGEST;
